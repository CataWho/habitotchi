...
export const ES = {
  ...
  idioma: "Idioma",
  sonido: "Sonido",
  sonidoActivado: "Sonido activado",
  notaSonido: "Los efectos de los juegos y un ambiente suave de fondo, generados por la app: no descarga ningún archivo. Es un ajuste de este aparato, como el idioma.",
